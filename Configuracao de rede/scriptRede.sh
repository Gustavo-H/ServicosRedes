...
function insert_persistent_config() {
    ...
    echo "#This file was generated by scriptRede.sh" > /etc/netplan/config.yaml
    ...
    if [ $dns2 = "null" ]; then
        ...
        echo -e "      gateway4: $gateway" >> /etc/netplan/config.yaml
        echo -e "      nameservers:" >> /etc/netplan/config.yaml   
        echo -e "        addresses: [$dns1]" >> /etc/netplan/config.yaml   
    else
        echo -e "network:" >> /etc/netplan/config.yaml
        echo -e "  version: 2" >> /etc/netplan/config.yaml
        echo -e "  ethernets:" >> /etc/netplan/config.yaml
        ...
        echo -e "      gateway4: $gateway" >> /etc/netplan/config.yaml
        echo -e "      nameservers:" >> /etc/netplan/config.yaml   
        echo -e "        addresses: [$dns1,$dns2]" >> /etc/netplan/config.yaml  
    fi
